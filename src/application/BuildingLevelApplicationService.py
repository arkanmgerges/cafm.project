...
class BuildingLevelApplicationService:
    ...
    def createBuildingLevel(self, id: str = None, name: str = '', buildingId: str = None, projectId: str = None,
        ...
        try:
            obj: BuildingLevel = self.constructObject(id=id, name=name, buildingIds=[], rooms=[], publishEvent=True)
            ...
            obj = self._buildingLevelService.addNewLevelIntoBuilding(obj=obj, obj2=obj2, tokenData=tokenData)
            return obj
    ...
    def constructObject(self, id: str = None, name: str = '', buildingIds: List[str] = None,
        ...
        return BuildingLevel.createFrom(id=id, name=name, buildingIds=buildingIds, rooms=rooms, publishEvent=publishEvent)
