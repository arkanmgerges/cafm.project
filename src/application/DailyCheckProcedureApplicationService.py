...
class DailyCheckProcedureApplicationService(BaseApplicationService):
    ...
    def createDailyCheckProcedure(
        ...
        **kwargs,
        ...
        if kwargs["equipmentId"] is None and kwargs["equipmentCategoryGroupId"] is None:
            raise InvalidArgumentException(f"Equipment id is none and Equipment category group is none for daily check procedure id: {obj.id()}")
