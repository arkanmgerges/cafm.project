...
class EquipmentCategoryGroupApplicationService(BaseApplicationService):
    ...
    def equipmentCategoryGroupsByEquipmentProjectCategoryId(
        ...
        **_kwargs,
        ...
        return super().callGetterFunction(
            modelData=BaseApplicationServiceModelData(
                getterFunction=self._equipmentCategoryGroupService.equipmentCategoryGroupsByEquipmentProjectCategoryId,
                kwargs={"resultFrom": resultFrom, "resultSize": resultSize, "order": order, "tokenData": tokenData, "equipmentProjectCategoryId": equipmentProjectCategoryId},
            )
        )
