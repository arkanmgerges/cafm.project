...
class MaintenanceProcedureApplicationService:
    ...
    @debugLogger
    def constructObject(self, id: str, name: str = None, type: str = None, subType: str = None, frequency: str = None,
                        startDate: int = None, subcontractorId: str = None,
                        equipmentId: str = None) -> MaintenanceProcedure:
