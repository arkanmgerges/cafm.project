...
class MaintenanceProcedureOperationParameterApplicationService:
    def __init__(
        ...
        self._repo = repo
        self._maintenanceProcedureOperationParameterService = (
            maintenanceProcedureOperationParameterService
        )
    ...
    def createMaintenanceProcedureOperationParameter(
        ...
        obj: MaintenanceProcedureOperationParameter = self.constructObject(
            id=id,
            name=name,
            unitId=unitId,
        ...
        self._maintenanceProcedureOperationRepo.maintenanceProcedureOperationById(
            id=maintenanceProcedureOperationId
        )
    ...
    def updateMaintenanceProcedureOperationParameter(
        ...
        try:
            oldObject: MaintenanceProcedureOperationParameter = (
                self._repo.maintenanceProcedureOperationParameterById(id=id)
            )
            obj: MaintenanceProcedureOperationParameter = self.constructObject(
                id=id,
                name=name,
            ...
            raise UpdateMaintenanceProcedureOperationParameterFailedException(
                message=str(e)
            )
    ...
    def bulkCreate(self, objListParams: List[dict], token: str = ""):
        ...
        for objListParamsItem in objListParams:
            try:
                ...
                objList.append(
                    self.constructObject(id=objListParamsItem["maintenance_procedure_operation_parameter_id"],
                                         name=objListParamsItem["name"],
                                         unitId=objListParamsItem["unit_id"],
                                         maintenanceProcedureOperationId=objListParamsItem[
    ...
    def bulkUpdate(self, objListParams: List[dict], token: str = ""):
        ...
        for objListParamsItem in objListParams:
            try:
                ...
                newObject = self.constructObject(id=objListParamsItem["maintenance_procedure_operation_parameter_id"],
                                                 name=objListParamsItem[
                                                     "name"] if "name" in objListParamsItem else None,
                                                 unitId=objListParamsItem[
                                                     "unit_id"] if "unit_id" in objListParamsItem else None,
                                                 maintenanceProcedureOperationId=objListParamsItem[
                                                     "maintenance_procedure_operation_id"] if "maintenance_procedure_operation_id" in objListParamsItem else None,
                                                 minValue=objListParamsItem[
                                                     "min_value"] if "min_value" in objListParamsItem else None,
                                                 maxValue=objListParamsItem[
                                                     "max_value"] if "max_value" in objListParamsItem else None,
                                                 _sourceObject=oldObject)
    ...
    def constructObject(
        ...
        if _sourceObject is not None:
            return MaintenanceProcedureOperationParameter.createFrom(
                ...
                maintenanceProcedureOperationId=maintenanceProcedureOperationId
                if maintenanceProcedureOperationId is not None
