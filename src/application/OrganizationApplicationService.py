...
class OrganizationApplicationService:
    ...
    def updateOrganization(self, id: str = None, name: str = None, websiteUrl: str = None, organizationType: str = None,
        ...
        try:
            ...
            obj: Organization = self.constructObject(id=id,
                                                     ...
                                                     managerEmail=managerEmail,
                                                     managerPhoneNumber=managerPhoneNumber,
                                                     managerAvatar=managerAvatar, _sourceObject = oldObject)
    ...
    def constructObject(self, id: str = None, name: str = None, websiteUrl: str = None, organizationType: str = None,
                        ...
                        managerAvatar: str = None, _sourceObject: Organization = None) -> Organization:
        if _sourceObject is not None:
            return Organization.createFrom(id=id,
                                           ...
                                           organizationType=organizationType if organizationType is not None else _sourceObject.organizationType(),
                                           ...
                                           managerFirstName=managerFirstName if managerFirstName is not None else _sourceObject.managerFirstName(),
                                           managerLastName=managerLastName if managerLastName is not None else _sourceObject.managerLastName(),
                                           managerEmail=managerEmail if managerEmail is not None else _sourceObject.managerEmail(),
                                           managerPhoneNumber=managerPhoneNumber if managerPhoneNumber is not None else _sourceObject.managerPhoneNumber(),
                                           managerAvatar=managerAvatar if managerAvatar is not None else _sourceObject.managerAvatar()
                                           )
        else:
            return Organization.createFrom(id=id,
                                       name=name,
