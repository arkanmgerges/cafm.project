    ...
    def updateProject(self, id: str, name: str = None, cityId: int = None, countryId: int = None,
        ...
        try:
            ...
            obj: Project = self.constructObject(id=id, name=name, cityId=cityId, countryId=countryId,
                                                ...
                                                beneficiaryId=beneficiaryId, startDate=startDate,
                                                developerName=developerName, developerCityId=developerCityId,
                                                ...
                                                developerContact=developerContact, developerEmail=developerEmail,
                                                developerPhoneNumber=developerPhoneNumber,
                                                developerWarranty=developerWarranty, _sourceObject=oldObject)
    ...
    def constructObject(self, id: str, name: str, cityId: int, countryId: int, addressLine: str,
        ...
        if _sourceObject is not None:
            return Project.createFrom(id=id,
                                      ...
                                      developerName=developerName if developerName is not None else _sourceObject.developerName(),
                                      developerCityId=developerCityId if developerCityId is not None else _sourceObject.developerCityId(),
                                      developerCountryId=developerCountryId if developerCountryId is not None else _sourceObject.developerCountryId(),
                                      developerAddressLineOne=developerAddressLineOne if developerAddressLineOne is not None else _sourceObject.developerAddressLineOne(),
                                      developerAddressLineTwo=developerAddressLineTwo if developerAddressLineTwo is not None else _sourceObject.developerAddressLineTwo(),
                                      developerContact=developerContact if developerContact is not None else _sourceObject.developerContact(),
                                      developerEmail=developerEmail if developerEmail is not None else _sourceObject.developerEmail(),
                                      developerPhoneNumber=developerPhoneNumber if developerPhoneNumber is not None else _sourceObject.developerPhoneNumber(),
                                      developerWarranty=developerWarranty if developerWarranty is not None else _sourceObject.developerWarranty(),
                                      )
        else:
