...
from src.domain_model.resource.exception.UpdateStandardEquipmentFailedException import UpdateStandardEquipmentFailedException
...
class StandardEquipmentApplicationService:
    def __init__(self, repo: StandardEquipmentRepository, standardEquipmentService: StandardEquipmentService,
    ...
    @debugLogger
    def createStandardEquipment(self, id: str = None, name: str = None, standardEquipmentCategoryId: str = None, standardEquipmentCategoryGroupId: str = None, manufacturerId: str = None, equipmentModelId: str = None, objectOnly: bool = False, token: str = ''):
        obj: StandardEquipment = self.constructObject(id=id, 
			name=name,
        ...
        return self._standardEquipmentService.createStandardEquipment(obj=obj, objectOnly=objectOnly, tokenData=tokenData)

    @debugLogger
    def updateStandardEquipment(self, id: str, name: str = None, standardEquipmentCategoryId: str = None, standardEquipmentCategoryGroupId: str = None, manufacturerId: str = None, equipmentModelId: str = None, token: str = None):
        tokenData = TokenService.tokenDataFromToken(token=token)
        try:
			...
			standardEquipmentCategoryGroupId=standardEquipmentCategoryGroupId,
			manufacturerId=manufacturerId,
			equipmentModelId=equipmentModelId, _sourceObject=oldObject)
            self._standardEquipmentService.updateStandardEquipment(oldObject=oldObject, newObject=obj, tokenData=tokenData)
    ...
    @debugLogger
    def standardEquipments(self, resultFrom: int = 0, resultSize: int = 100, order: List[dict] = None,
                        token: str = None) -> dict:
        tokenData = TokenService.tokenDataFromToken(token=token)
        return self._standardEquipmentService.standardEquipments(tokenData=tokenData, resultFrom=resultFrom, resultSize=resultSize, order=order)

    @debugLogger
    def constructObject(self, id: str, name: str = None, standardEquipmentCategoryId: str = None, standardEquipmentCategoryGroupId: str = None, manufacturerId: str = None, equipmentModelId: str = None, _sourceObject: StandardEquipment = None) -> StandardEquipment:
