...
class StandardEquipmentCategoryApplicationService:
    ...
    def createStandardEquipmentCategory(
        ...
        obj: StandardEquipmentCategory = self.constructObject(id=id, name=name)
    ...
    def updateStandardEquipmentCategory(
        self, id: str, name: str = None, token: str = None
    ):
        tokenData = TokenService.tokenDataFromToken(token=token)
        try:
            oldObject: StandardEquipmentCategory = (
                self._repo.standardEquipmentCategoryById(id=id)
            )
            obj: StandardEquipmentCategory = self.constructObject(
    ...
    def deleteStandardEquipmentCategory(self, id: str, token: str = None):
        ...
        self._standardEquipmentCategoryService.deleteStandardEquipmentCategory(
    ...
    def constructObject(
        ...
        if _sourceObject is not None:
            ...
            return StandardEquipmentCategory.createFrom(id=id, name=name, skipValidation=skipValidation,)
