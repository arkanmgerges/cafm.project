...
class StandardEquipmentCategoryGroupApplicationService:
    def __init__(self, repo: StandardEquipmentCategoryGroupRepository,
    ...
    @debugLogger
    def createStandardEquipmentCategoryGroup(self, id: str = None, name: str = None,
                                             standardEquipmentCategoryId: str = None, objectOnly: bool = False,
                                             token: str = ''):
        ...
        return self._standardEquipmentCategoryGroupService.createStandardEquipmentCategoryGroup(obj=obj,
                                                                                                objectOnly=objectOnly,
                                                                                                tokenData=tokenData)

    @debugLogger
    def updateStandardEquipmentCategoryGroup(self, id: str, name: str = None, standardEquipmentCategoryId: str = None,
                                             token: str = None):
        tokenData = TokenService.tokenDataFromToken(token=token)
        try:
            ...
            self._standardEquipmentCategoryGroupService.updateStandardEquipmentCategoryGroup(oldObject=oldObject,
                                                                                             newObject=obj,
                                                                                             tokenData=tokenData)
    ...
    def standardEquipmentCategoryGroups(self, resultFrom: int = 0, resultSize: int = 100, order: List[dict] = None,
                                        token: str = None) -> dict:
        tokenData = TokenService.tokenDataFromToken(token=token)
        return self._standardEquipmentCategoryGroupService.standardEquipmentCategoryGroups(tokenData=tokenData,
    ...
    def constructObject(self, id: str, name: str = None, standardEquipmentCategoryId: str = None,
                        _sourceObject: StandardEquipmentCategoryGroup = None) -> StandardEquipmentCategoryGroup:
