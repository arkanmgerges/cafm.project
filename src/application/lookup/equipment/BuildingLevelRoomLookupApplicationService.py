...
from src.application.lookup.equipment.BuildingLevelRoomLookupRepository import (
    BuildingLevelRoomLookupRepository,
)
...
class BuildingLevelRoomLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: BuildingLevelRoomLookupRepository):
        self._repo = repo
