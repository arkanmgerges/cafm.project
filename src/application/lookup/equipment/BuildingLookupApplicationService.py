...
from src.application.lookup.equipment.BuildingLookupRepository import (
    BuildingLookupRepository,
)
...
class BuildingLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: BuildingLookupRepository):
        self._repo = repo
