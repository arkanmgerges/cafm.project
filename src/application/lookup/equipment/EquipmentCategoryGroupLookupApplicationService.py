...
from src.application.lookup.equipment.EquipmentCategoryGroupLookupRepository import (
    EquipmentCategoryGroupLookupRepository,
)
...
class EquipmentCategoryGroupLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: EquipmentCategoryGroupLookupRepository):
        self._repo = repo
