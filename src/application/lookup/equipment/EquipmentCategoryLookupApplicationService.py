...
from src.application.lookup.equipment.EquipmentCategoryLookupRepository import (
    EquipmentCategoryLookupRepository,
)
...
class EquipmentCategoryLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: EquipmentCategoryLookupRepository):
        self._repo = repo
