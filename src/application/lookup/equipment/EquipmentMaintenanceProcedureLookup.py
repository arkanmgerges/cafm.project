...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationLookup import EquipmentMaintenanceProcedureOperationLookup

class EquipmentMaintenanceProcedureLookup(HasToMap, BaseLookupModel):
    __slots__ = [
        "id",
        "name",
        "type",
    ...
    def toMap(self) -> dict:
        return super()._toMap(EquipmentMaintenanceProcedureLookup.attributes())
    ...
    def attributes(cls):
        return {
            ...
            "maintenanceProcedureOperations":LookupModelAttributeData(
                    dataType=EquipmentMaintenanceProcedureOperationLookup, isLookupClass=True
                ),
        }
