...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationParameterLookup import EquipmentMaintenanceProcedureOperationParameterLookup

class EquipmentMaintenanceProcedureOperationLookup(HasToMap, BaseLookupModel):
    __slots__ = [
        "id",
        "name",
        "description",
    ...
    def toMap(self) -> dict:
        return super()._toMap(EquipmentMaintenanceProcedureOperationLookup.attributes())
    ...
    def attributes(cls):
        return {
            ...
            "maintenanceProcedureOperationParameters":LookupModelAttributeData(
                    dataType=EquipmentMaintenanceProcedureOperationParameterLookup, isLookupClass=True
                ),
        }
