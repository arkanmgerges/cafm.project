...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationLookupRepository import (
    EquipmentMaintenanceProcedureOperationLookupRepository,
)
...
class EquipmentMaintenanceProcedureOperationLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: EquipmentMaintenanceProcedureOperationLookupRepository):
        self._repo = repo

    @debugLogger
    def createMaintenanceProcedureOperation(self, *args, **kwargs):
        _tokenData = TokenService.tokenDataFromToken(token=kwargs["token"])
        obj: MaintenanceProcedureOperation = self._constructObject(*args, **kwargs)
        self._repo.save(obj=obj)

    @debugLogger
    def updateMaintenanceProcedureOperation(self, *args, **kwargs):
        _tokenData = TokenService.tokenDataFromToken(token=kwargs["token"])
    ...
    @debugLogger
    def bulkCreateMaintenanceProcedureOperation(self, objListParams: List[dict], token: str = ""):
        objList = []
        exceptions = []
