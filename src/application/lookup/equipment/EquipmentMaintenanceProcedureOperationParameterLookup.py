...
from src.application.lookup.equipment.EquipmentUnitLookup import EquipmentUnitLookup

class EquipmentMaintenanceProcedureOperationParameterLookup(HasToMap, BaseLookupModel):
    __slots__ = [
        "id",
        "name",
        "minValue",
    ...
    def toMap(self) -> dict:
        return super()._toMap(EquipmentMaintenanceProcedureOperationParameterLookup.attributes())
    ...
    def attributes(cls):
        return {
            ...
            "unit":LookupModelAttributeData(
                    dataType=EquipmentUnitLookup, isLookupClass=True
                ),
        }
