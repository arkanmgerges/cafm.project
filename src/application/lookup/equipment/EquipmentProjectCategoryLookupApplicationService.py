...
from src.application.lookup.equipment.EquipmentProjectCategoryLookupRepository import (
    EquipmentProjectCategoryLookupRepository,
)
...
class EquipmentProjectCategoryLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: EquipmentProjectCategoryLookupRepository):
        self._repo = repo
