...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationLookup import MaintenanceProcedureOperationLookup

class MaintenanceProcedureLookup(HasToMap, BaseLookupModel):
    __slots__ = [
        "id",
        "name",
        "type",
    ...
    def toMap(self) -> dict:
        return super()._toMap(MaintenanceProcedureLookup.attributes())
