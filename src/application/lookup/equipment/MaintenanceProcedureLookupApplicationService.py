...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureLookupRepository import (
    MaintenanceProcedureLookupRepository,
)
...
class MaintenanceProcedureLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: MaintenanceProcedureLookupRepository):
        self._repo = repo
