...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationParameterLookup import MaintenanceProcedureOperationParameterLookup
    ...
    def attributes(cls):
        return {
            ...
            "maintenanceProcedureOperationParameters":LookupModelAttributeData(
                    dataType=MaintenanceProcedureOperationParameterLookup, isLookupClass=True
                ),
        }
