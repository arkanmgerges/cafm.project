...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationLookupRepository import (
    MaintenanceProcedureOperationLookupRepository,
)
...
class MaintenanceProcedureOperationLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: MaintenanceProcedureOperationLookupRepository):
        self._repo = repo
