...
from src.application.lookup.equipment.EquipmentUnitLookup import UnitLookup

class MaintenanceProcedureOperationParameterLookup(HasToMap, BaseLookupModel):
    __slots__ = [
        "id",
        "name",
        "minValue",
    ...
    def toMap(self) -> dict:
        return super()._toMap(MaintenanceProcedureOperationParameterLookup.attributes())
    ...
    def attributes(cls):
        return {
            ...
            "unit":LookupModelAttributeData(
                    dataType=UnitLookup, isLookupClass=True
                ),
        }
