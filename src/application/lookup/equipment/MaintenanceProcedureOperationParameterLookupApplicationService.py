...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationParameterLookupRepository import (
    MaintenanceProcedureOperationParameterLookupRepository,
)
...
class MaintenanceProcedureOperationParameterLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: MaintenanceProcedureOperationParameterLookupRepository):
        self._repo = repo
