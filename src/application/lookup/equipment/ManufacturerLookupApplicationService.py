...
from src.application.lookup.equipment.ManufacturerLookupRepository import (
    ManufacturerLookupRepository,
)
...
class ManufacturerLookupApplicationService(BaseApplicationService):
    def __init__(self, repo: ManufacturerLookupRepository):
        self._repo = repo
