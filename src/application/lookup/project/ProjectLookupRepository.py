...
class ProjectLookupRepository(ABC):
    ...
    @abstractmethod
    def projectsIncludeOrganizationsIncludeUsersIncludeRolesFilteredByProjectsIncludeOrganizationsIncludeUsersIncludeRoles(self, tokenData: TokenData, resultFrom: int = 0, resultSize: int = 10,
                                                                                                                           order: List[dict] = None, projectsIncludeOrganizationsIncludeUsersIncludeRoles: List[ProjectIncludesOrganizationsIncludeUsersIncludeRoles] = None) -> dict:
