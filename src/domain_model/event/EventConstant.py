...
class CommonEventConstant(Enum):
    ...
    MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_CREATED = 'maintenance_procedure_operation_parameter_created'
    MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_UPDATED = 'maintenance_procedure_operation_parameter_updated'
    MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_DELETED = 'maintenance_procedure_operation_parameter_deleted'
    ...
    STANDARD_EQUIPMENT_CATEGORY_GROUP_CREATED = 'standard_equipment_category_group_created'
    STANDARD_EQUIPMENT_CATEGORY_GROUP_UPDATED = 'standard_equipment_category_group_updated'
    STANDARD_EQUIPMENT_CATEGORY_GROUP_DELETED = 'standard_equipment_category_group_deleted'
