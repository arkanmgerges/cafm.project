...
class CommonEventConstant(Enum):
    ...
    BUILDING_LEVEL_ROOM_FROM_BUILDING_LEVEL_REMOVED = 'building_level_room_from_building_level_removed'
    ...
    BUILDING_LEVEL_ROOM_TO_BUILDING_LEVEL_ADDED = 'building_level_room_to_building_level_added'
