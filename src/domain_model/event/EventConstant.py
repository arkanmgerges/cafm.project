...
class CommonEventConstant(Enum):
    ...
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_CREATED = "standard_maintenance_procedure_operation_created"
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_UPDATED = "standard_maintenance_procedure_operation_updated"
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_DELETED = "standard_maintenance_procedure_operation_deleted"
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_CREATED = "standard_maintenance_procedure_operation_parameter_created"
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_UPDATED = "standard_maintenance_procedure_operation_parameter_updated"
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_PARAMETER_DELETED = "standard_maintenance_procedure_operation_parameter_deleted"
    ...
    DAILY_CHECK_PROCEDURE_OPERATION_LABEL_CREATED = 'daily_check_procedure_operation_label_created'
    DAILY_CHECK_PROCEDURE_OPERATION_LABEL_UPDATED = 'daily_check_procedure_operation_label_updated'
    DAILY_CHECK_PROCEDURE_OPERATION_LABEL_DELETED = 'daily_check_procedure_operation_label_deleted'
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_LABEL_CREATED = 'standard_maintenance_procedure_operation_label_created'
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_LABEL_UPDATED = 'standard_maintenance_procedure_operation_label_updated'
    STANDARD_MAINTENANCE_PROCEDURE_OPERATION_LABEL_DELETED = 'standard_maintenance_procedure_operation_label_deleted'
    MAINTENANCE_PROCEDURE_OPERATION_LABEL_CREATED = 'maintenance_procedure_operation_label_created'
    MAINTENANCE_PROCEDURE_OPERATION_LABEL_UPDATED = 'maintenance_procedure_operation_label_updated'
    MAINTENANCE_PROCEDURE_OPERATION_LABEL_DELETED = 'maintenance_procedure_operation_label_deleted'
