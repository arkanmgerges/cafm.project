...
class Organization:
    ...
    def update(self, data: dict):
        ...
        if 'website_url' in data and data['website_url'] != self._websiteUrl and data['website_url'] is not None:
            updated = True
            self._websiteUrl = data['website_url']
        if 'organization_type' in data and data['organization_type'] != self._organizationType and \
                data['organization_type'] is not None:
            updated = True
        ...
        if 'manager_last_name' in data and data['manager_last_name'] != self._managerLastName and data[
            'manager_last_name'] is not None:
            updated = True
            self._managerLastName = data['manager_last_name']
        if 'manager_email' in data and data['manager_email'] != self._managerEmail and data[
            'manager_email'] is not None:
            updated = True
            self._managerEmail = data['manager_email']
        if 'manager_phone_number' in data and data['manager_phone_number'] != self._managerPhoneNumber and \
                data['manager_phone_number'] is not None:
            updated = True
            self._managerPhoneNumber = data['manager_phone_number']
        if 'manager_avatar' in data and data['manager_avatar'] != self._managerAvatar and data[
            'manager_avatar'] is not None:
            updated = True
    ...
    def __eq__(self, other) -> bool:
        ...
        return self.id() == other.id() and self.name() == other.name() and self.websiteUrl() == other.websiteUrl() and \
               ...
               self.managerPhoneNumber() == other.managerPhoneNumber() and \
               self.managerAvatar() == other.managerAvatar()
