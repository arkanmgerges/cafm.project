...
class PolicyService:
    ...
    def assignRoleToUser(self, role: Role, user: User, tokenData: TokenData = None):
        self._repo.assignRoleToUser(role=role, user=user, tokenData=tokenData)
    ...
    def revokeRoleToUserAssignment(self, role: Role, user: User, tokenData: TokenData = None):
        self._repo.revokeRoleToUserAssignment(role=role, user=user, tokenData=tokenData)
    ...
    def assignUserToOrganization(self, organization: Organization, user: User, tokenData: TokenData = None):
        self._repo.assignUserToOrganization(organization=organization, user=user, tokenData=tokenData)
    ...
    def revokeUserToOrganizationAssignment(self, organization: Organization, user: User, tokenData: TokenData = None):
        self._repo.revokeUserToOrganizationAssignment(organization=organization, user=user, tokenData=tokenData)
