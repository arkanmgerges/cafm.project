...
class DailyCheckProcedureOperationRepository(ABC):
    ...
    @abstractmethod
    def dailyCheckProcedureOperations(self, tokenData: TokenData, resultFrom: int = 0, resultSize: int = 100,
    ...
    @abstractmethod
    def dailyCheckProcedureOperationsByDailyCheckProcedureId(self, tokenData: TokenData, 
