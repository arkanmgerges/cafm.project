...
class DailyCheckProcedureOperationLabelDeleted(DomainEvent):
    def __init__(self, obj: DailyCheckProcedureOperationLabel):
        super().__init__(id=str(uuid4()), name=CommonEventConstant.DAILY_CHECK_PROCEDURE_OPERATION_LABEL_DELETED.value)
