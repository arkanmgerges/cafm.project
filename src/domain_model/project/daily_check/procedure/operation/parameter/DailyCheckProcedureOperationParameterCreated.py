...
class DailyCheckProcedureOperationParameterCreated(DomainEvent):
    def __init__(self, obj: DailyCheckProcedureOperationParameter):
        super().__init__(id=str(uuid4()), name=CommonEventConstant.DAILY_CHECK_PROCEDURE_OPERATION_PARAMETER_CREATED.value)
