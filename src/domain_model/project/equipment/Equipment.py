    ...
    def __init__(
        ...
        if not skipValidation:
            ...
            if equipmentCategoryGroupId is None or equipmentCategoryGroupId == "":
                ...
                raise InvalidArgumentException(
                    f"Invalid equipment group id: {equipmentCategoryGroupId}, for equipment id: {id}"
                )
            ...
            if buildingId is None or buildingId == "":
                ...
                raise InvalidArgumentException(
                    f"Invalid equipment building id: {buildingId}, for equipment id: {id}"
                )
            if buildingLevelId is None or buildingLevelId == "":
                ...
                raise InvalidArgumentException(
                    f"Invalid equipment level id: {buildingLevelId}, for equipment id: {id}"
                )
            if buildingLevelRoomId is None or buildingLevelRoomId == "":
                ...
                raise InvalidArgumentException(
                    f"Invalid equipment room id: {buildingLevelRoomId}, for equipment id: {id}"
                )
            ...
            if quantity <= -1:
                ...
                raise InvalidArgumentException(
                    f"Invalid equipment quantity: {quantity}, for equipment id: {id}"
                )
    ...
    def __eq__(self, other):
        if not isinstance(other, Equipment):
            raise NotImplementedError(
                f"other: {other} can not be compared with Equipment class"
            )
        return (
            self.id() == other.id()
