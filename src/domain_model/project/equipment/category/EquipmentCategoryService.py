...
class EquipmentCategoryService:
    ...
    @debugLogger
    def updateEquipmentCategory(self, oldObject: EquipmentCategory, newObject: EquipmentCategory,
    ...
    def equipmentCategorys(self, tokenData: TokenData = None, resultFrom: int = 0, resultSize: int = 100,
        ...
        return self._repo.equipmentCategorys(tokenData=tokenData, resultFrom=resultFrom, resultSize=resultSize,
                                             order=order)

    @debugLogger
    def equipmentCategoryGroupsByCategoryId(self, tokenData: TokenData = None, id: str = '',
                                            resultFrom: int = 0,
                                            resultSize: int = 100,
                                            order: List[dict] = None):
        return self._repo.equipmentCategoryGroupsByCategoryId(tokenData=tokenData, id=id, resultFrom=resultFrom,
