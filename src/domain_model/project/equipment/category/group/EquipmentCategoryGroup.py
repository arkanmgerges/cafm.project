...
class EquipmentCategoryGroup:
    def __init__(self, id: str = None, name: str = None, equipmentCategoryId: str = None, skipValidation: bool = False):
    ...
    @classmethod
    def createFrom(cls, id: str = None, name: str = '', equipmentCategoryId: str = None, publishEvent: bool = False, skipValidation: bool = False):
        from src.domain_model.project.equipment.category.group.EquipmentCategoryGroupCreated import EquipmentCategoryGroupCreated
    ...
    @classmethod
    def createFromObject(cls, obj: 'EquipmentCategoryGroup', publishEvent: bool = False, generateNewId: bool = False,
    ...
    def publishDelete(self):
        from src.domain_model.project.equipment.category.group.EquipmentCategoryGroupDeleted import EquipmentCategoryGroupDeleted
        DomainPublishedEvents.addEventForPublishing(EquipmentCategoryGroupDeleted(self))

    def publishUpdate(self, old):
        from src.domain_model.project.equipment.category.group.EquipmentCategoryGroupUpdated import EquipmentCategoryGroupUpdated
        DomainPublishedEvents.addEventForPublishing(EquipmentCategoryGroupUpdated(old, self))

    def toMap(self) -> dict:
        return {'equipment_category_group_id': self.id(), 'name': self.name(), 'equipment_category_id': self.equipmentCategoryId()}
    ...
    def __eq__(self, other):
        if not isinstance(other, EquipmentCategoryGroup):
            raise NotImplementedError(f'other: {other} can not be compared with EquipmentCategoryGroup class')
