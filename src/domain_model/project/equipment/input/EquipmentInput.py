...
class EquipmentInput:
    ...
    @classmethod
    def createFromObject(cls, obj: 'EquipmentInput', publishEvent: bool = False, generateNewId: bool = False,
    ...
    def publishDelete(self):
        from src.domain_model.project.equipment.input.EquipmentInputDeleted import EquipmentInputDeleted
        DomainPublishedEvents.addEventForPublishing(EquipmentInputDeleted(self))

    def publishUpdate(self, old):
        from src.domain_model.project.equipment.input.EquipmentInputUpdated import EquipmentInputUpdated
