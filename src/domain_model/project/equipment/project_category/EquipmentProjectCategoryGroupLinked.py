...
"""
c4model|cb|project:ComponentQueue(project__domainmodel_event__EquipmentProjectCategoryGroupLinked, "CommonEventConstant.EQUIPMENT_PROJECT_CATEGORY_GROUP_LINKED.value", "message", "event")
"""


class EquipmentProjectCategoryGroupLinked(DomainEvent):
    def __init__(self, category: EquipmentProjectCategory, group: EquipmentCategoryGroup):
        super().__init__(id=str(uuid4()), name=CommonEventConstant.EQUIPMENT_PROJECT_CATEGORY_GROUP_LINKED.value)
