...
class MaintenanceProcedure:
    def __init__(self, id: str = None, name: str = None, type: str = None, frequency: str = None, startDate: int = None, equipmentId: str = None, subcontractorId: str = None, skipValidation: bool = False):
    ...
    @classmethod
    def createFrom(cls, id: str = None, name: str = None, type: str = None, frequency: str = None, startDate: int = None, equipmentId: str = None, subcontractorId: str = None, publishEvent: bool = False, skipValidation: bool = False):
        from src.domain_model.project.maintenance.procedure.MaintenanceProcedureCreated import MaintenanceProcedureCreated
        obj = MaintenanceProcedure(id=id, name=name, type=type, frequency=frequency, startDate=startDate, equipmentId=equipmentId, subcontractorId=subcontractorId, skipValidation=skipValidation)

        if publishEvent:
            logger.debug(
                f'[{MaintenanceProcedure.createFrom.__qualname__}] - Create maintenance procedure with id: {id}')
            DomainPublishedEvents.addEventForPublishing(MaintenanceProcedureCreated(obj))
        return obj
    ...
    def createFromObject(cls, obj: 'MaintenanceProcedure', publishEvent: bool = False, generateNewId: bool = False,
        ...
        return cls.createFrom(id=id, name=obj.name(), type=obj.type(), frequency=obj.frequency(), startDate=obj.startDate(), equipmentId=obj.equipmentId(), subcontractorId=obj.subcontractorId(),
    ...
    def publishDelete(self):
        from src.domain_model.project.maintenance.procedure.MaintenanceProcedureDeleted import MaintenanceProcedureDeleted
        DomainPublishedEvents.addEventForPublishing(MaintenanceProcedureDeleted(self))

    def publishUpdate(self, old):
        from src.domain_model.project.maintenance.procedure.MaintenanceProcedureUpdated import MaintenanceProcedureUpdated
        DomainPublishedEvents.addEventForPublishing(MaintenanceProcedureUpdated(old, self))
    ...
    def __eq__(self, other):
        if not isinstance(other, MaintenanceProcedure):
            raise NotImplementedError(f'other: {other} can not be compared with MaintenanceProcedure class')
        return self.id() == other.id() and self.name() == other.name() and self.type() == other.type() and self.frequency() == other.frequency() and \
               self.startDate() == other.startDate() and self.subcontractorId() == other.subcontractorId() and \
