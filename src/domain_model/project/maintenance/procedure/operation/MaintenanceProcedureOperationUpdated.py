...
class MaintenanceProcedureOperationUpdated(DomainEvent):
    def __init__(self, oldObj: MaintenanceProcedureOperation, newObj: MaintenanceProcedureOperation):
        super().__init__(id=str(uuid4()), name=CommonEventConstant.MAINTENANCE_PROCEDURE_OPERATION_UPDATED.value)
