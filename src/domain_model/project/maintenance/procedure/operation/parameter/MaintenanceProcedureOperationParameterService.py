...
class MaintenanceProcedureOperationParameterService:
    ...
    @debugLogger
    def bulkCreate(self, objList: List[MaintenanceProcedureOperationParameter]):
        self._repo.bulkSave(objList=objList)
        for obj in objList:
            MaintenanceProcedureOperationParameter.createFromObject(obj=obj, publishEvent=True)

    @debugLogger
    def bulkDelete(self, objList: List[MaintenanceProcedureOperationParameter]):
