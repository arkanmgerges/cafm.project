...
class StandardEquipmentCategoryGroupUpdated(DomainEvent):
    def __init__(self, oldObj: StandardEquipmentCategoryGroup, newObj: StandardEquipmentCategoryGroup):
        super().__init__(id=str(uuid4()), name=CommonEventConstant.STANDARD_EQUIPMENT_CATEGORY_GROUP_UPDATED.value)
