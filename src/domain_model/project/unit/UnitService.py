...
from src.domain_model.resource.exception.UnitAlreadyExistException import UnitAlreadyExistException
...
class UnitService:
    ...
    def units(self, tokenData: TokenData = None, resultFrom: int = 0, resultSize: int = 100,
        ...
        return self._repo.units(tokenData=tokenData, resultFrom=resultFrom, resultSize=resultSize, order=order)
