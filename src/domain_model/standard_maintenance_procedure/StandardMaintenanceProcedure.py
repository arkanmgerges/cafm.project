...
class StandardMaintenanceProcedure:
        ...
        if not skipValidation:
            ...
            if not self._isSubtype(type, subtypeList):
                ...
                raise InvalidArgumentException(
                    ...
                    f'only these types are supported: ' + ', '.join(
                        [e.value for e in MaintenanceProcedureHardSubType]) +
    ...
    def toMap(self) -> dict:
        return {'standard_maintenance_procedure_id': self.id(), 'name': self.name(), 'type': self.type(),
                'subtype': self.subtype(), 'frequency': self.frequency(), 'start_date': self.startDate(),
