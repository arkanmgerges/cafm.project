...
class SubcontractorCategoryService:
    ...
    def createSubcontractorCategory(
        ...
        if objectOnly:
            return (
                SubcontractorCategory.createFromObject(obj=obj, generateNewId=True)
                if obj.id() == ""
                else obj
            )
        else:
    ...
    def updateSubcontractorCategory(
        self,
        oldObject: SubcontractorCategory,
        newObject: SubcontractorCategory,
        tokenData: TokenData = None,
    ):
    ...
    @debugLogger
    def bulkCreate(self, objList: List[SubcontractorCategory]):
        self._repo.bulkSave(objList=objList)
        for obj in objList:
            SubcontractorCategory.createFromObject(obj=obj, publishEvent=True)

    @debugLogger
    def bulkDelete(self, objList: List[SubcontractorCategory]):
    ...
    def subcontractorCategories(
        ...
        return self._repo.subcontractorCategories(
            tokenData=tokenData,
