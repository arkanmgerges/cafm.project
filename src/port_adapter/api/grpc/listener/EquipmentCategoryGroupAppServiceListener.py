...
class EquipmentCategoryGroupAppServiceListener(
    ...
    def newId(self, request, context):
        try:
            ...
            logger.debug(
                f"[{EquipmentCategoryGroupAppServiceListener.newId.__qualname__}] - claims: {claims}\n\t \
                    token: {token}"
            )
    ...
    def equipmentCategoryGroups(self, request, context):
        try:
            ...
            logger.debug(
                f"[{EquipmentCategoryGroupAppServiceListener.equipmentCategoryGroups.__qualname__}] - claims: {claims}\n\t \
