...
class EquipmentProjectCategoryAppServiceListener(
    EquipmentProjectCategoryAppServiceServicer, BaseListener
):
    ...
    def newId(self, request, context):
        try:
            ...
            logger.debug(
                f"[{EquipmentProjectCategoryAppServiceListener.newId.__qualname__}] - claims: {claims}\n\t \
                    token: {token}"
            )
    ...
    def equipmentProjectCategories(self, request, context):
        try:
            ...
            logger.debug(
                f"[{EquipmentProjectCategoryAppServiceListener.equipmentProjectCategories.__qualname__}] - claims: {claims}\n\t \
resultFrom: {request.resultFrom}, resultSize: {resultSize}, token: {token}"
    ...
    def equipmentCategoryGroupsByProjectCategoryId(self, request, context):
        try:
            ...
            logger.debug(
                f"[{EquipmentProjectCategoryAppServiceListener.equipmentCategoryGroupsByProjectCategoryId.__qualname__}] - claims: {claims}\n\t \
        resultFrom: {request.resultFrom}, resultSize: {resultSize}, token: {token}"
            )
            equipmentProjectCategoryAppService: EquipmentProjectCategoryApplicationService = AppDi.instance.get(
                EquipmentProjectCategoryApplicationService
