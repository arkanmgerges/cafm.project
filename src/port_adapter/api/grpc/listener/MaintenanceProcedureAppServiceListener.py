...
resultFrom: {request.resultFrom}, resultSize: {resultSize}, token: {token}')
            ...
            logger.debug(f'[{MaintenanceProcedureAppServiceListener.maintenanceProcedures.__qualname__}] - response: {response}')
            return MaintenanceProcedureAppService_maintenanceProceduresResponse(maintenanceProcedures=response.maintenanceProcedures,
    ...
    def maintenanceProcedureById(self, request, context):
        try:
            ...
            logger.debug(f'[{MaintenanceProcedureAppServiceListener.maintenanceProcedureById.__qualname__}] - response: {obj}')
