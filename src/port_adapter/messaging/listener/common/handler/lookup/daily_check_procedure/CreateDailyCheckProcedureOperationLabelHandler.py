...
class CreateDailyCheckProcedureOperationLabelHandler(Handler):
    ...
    def handleMessage(self, messageData: dict, extraData: dict = None) -> dict:
        ...
        dailyCheckProcedureOperationLabelAppService.createDailyCheckProcedureOperationLabel(**Util.snakeCaseToLowerCameCaseDict(dataDict), token=metadataDict['token'])
        return None
