...
class DeleteDailyCheckProcedureOperationParameterHandler(Handler):
    ...
    def handleCommand(self, messageData: dict, extraData: dict = None) -> dict:
        ...
        dailyCheckProcedureOperationParameterAppService.deleteDailyCheckProcedureOperationParameter(**Util.snakeCaseToLowerCameCaseDict(dataDict), token=metadataDict['token'])
        return None
