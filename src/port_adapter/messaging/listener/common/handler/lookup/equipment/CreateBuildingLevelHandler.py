...
from src.application.lookup.equipment.BuildingLevelApplicationService import BuildingLevelApplicationService
...
class CreateBuildingLevelHandler(Handler):
    ...
    def handleMessage(self, messageData: dict, extraData: dict = None) -> dict:
        ...
        buildingLevelAppService.createBuildingLevel(**Util.snakeCaseToLowerCameCaseDict(dataDict), token=metadataDict['token'])
        return None
