...
class UpdateOrganizationHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        appService.updateOrganization(id=dataDict['organization_id'],
                                      ...
                                      organizationType=dataDict['organization_type'] if 'organization_type' in dataDict else None,
                                      ...
                                      countryStateName=dataDict['country_state_name'] if 'country_state_name' in dataDict else None,
                                      managerFirstName=dataDict['manager_first_name'] if 'manager_first_name' in dataDict else None,
                                      managerLastName=dataDict['manager_last_name'] if 'manager_last_name' in dataDict else None,
                                      managerEmail=dataDict['manager_email'] if 'manager_email' in dataDict else None,
                                      managerPhoneNumber=dataDict['manager_phone_number'] if 'manager_phone_number' in dataDict else None,
                                      managerAvatar=dataDict['manager_avatar'] if 'manager_avatar' in dataDict else None,
