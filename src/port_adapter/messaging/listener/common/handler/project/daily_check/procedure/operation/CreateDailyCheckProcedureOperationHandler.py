...
class CreateDailyCheckProcedureOperationHandler(Handler):
    def __init__(self):
        self._commandConstant = (
            CommonCommandConstant.CREATE_DAILY_CHECK_PROCEDURE_OPERATION
        )
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        obj = appService.createDailyCheckProcedureOperation(
            id=id,
            name=dataDict["name"],
        ...
        data = dataDict
        data["daily_check_procedure_operation_id"] = obj.id()
        return {
