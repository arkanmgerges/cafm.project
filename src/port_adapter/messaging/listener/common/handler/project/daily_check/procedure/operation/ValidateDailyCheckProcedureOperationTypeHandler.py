...
class ValidateDailyCheckProcedureOperationTypeHandler(Handler):
    def __init__(self):
    ...
    def handleCommand(self, messageData: dict, extraData: dict = None) -> dict:
        ...
        logger.debug(
            f"[{ValidateDailyCheckProcedureOperationTypeHandler.handleCommand.__qualname__}] - received args:\ntype(name): {type(name)}, name: {name}\ntype(data): {type(data)}, data: {data}\ntype(metadata): {type(metadata)}, metadata: {metadata}"
        )
