...
class UpdateDailyCheckProcedureOperationParameterHandler(Handler):
    def __init__(self):
        self._commandConstant = (
            CommonCommandConstant.UPDATE_DAILY_CHECK_PROCEDURE_OPERATION_PARAMETER
        )
    ...
    def handleCommand(self, messageData: dict, extraData: dict = None) -> dict:
        ...
        id = (
            dataDict["daily_check_procedure_operation_parameter_id"]
            if "daily_check_procedure_operation_parameter_id" in dataDict
            else None
        )
        appService.updateDailyCheckProcedureOperationParameter(
            ...
            dailyCheckProcedureOperationId=dataDict[
