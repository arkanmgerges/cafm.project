...
class UpdateEquipmentHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        appService.updateEquipment(id=id,
                                   ...
                                   equipmentProjectCategoryId=dataDict["equipment_project_category_id"] if 'equipment_project_category_id' in dataDict else None,
                                   equipmentCategoryId=dataDict["equipment_category_id"] if 'equipment_category_id' in dataDict else None,
                                   equipmentCategoryGroupId=dataDict["equipment_category_group_id"] if 'equipment_category_group_id' in dataDict else None,
                                   buildingId=dataDict["building_id"] if 'building_id' in dataDict else None,
                                   buildingLevelId=dataDict["building_level_id"] if 'building_level_id' in dataDict else None,
                                   buildingLevelRoomId=dataDict["building_level_room_id"] if 'building_level_room_id' in dataDict else None,
                                   manufacturerId=dataDict["manufacturer_id"] if 'manufacturer_id' in dataDict else None,
                                   equipmentModelId=dataDict["equipment_model_id"] if 'equipment_model_id' in dataDict else None,
