...
class UpdateEquipmentHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        appService.updateEquipment(id=id, name=dataDict["name"], projectId=dataDict["project_id"],
                                   ...
                                   buildingId=dataDict["building_id"], buildingLevelId=dataDict["building_level_id"],
        ...
        return {'name': self._commandConstant.value, 'created_on': DateTimeHelper.utcNow(),
                'data': {'id': id, "name": dataDict["name"], "project_id": dataDict["project_id"],
                         ...
                         "building_id": dataDict["building_id"], "building_level_id": dataDict["building_level_id"],
                         "building_level_room_id": dataDict["building_level_room_id"],
                         "manufacturer_id": dataDict["manufacturer_id"],
                         "equipment_model_id": dataDict["equipment_model_id"], "quantity": dataDict["quantity"]},
