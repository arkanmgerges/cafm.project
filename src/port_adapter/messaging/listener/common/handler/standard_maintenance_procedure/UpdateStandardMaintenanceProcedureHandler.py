...
class UpdateStandardMaintenanceProcedureHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        id = dataDict['standard_maintenance_procedure_id'] if 'standard_maintenance_procedure_id' in dataDict else None
        appService.updateStandardMaintenanceProcedure(id=id, 
