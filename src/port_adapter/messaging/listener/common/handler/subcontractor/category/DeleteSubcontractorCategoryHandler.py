...
class DeleteSubcontractorCategoryHandler(Handler):

    def __init__(self):
        self._commandConstant = CommonCommandConstant.DELETE_SUBCONTRACTOR_CATEGORY
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        appService.deleteSubcontractorCategory(id=dataDict['subcontractor_category_id'], token=metadataDict['token'])
