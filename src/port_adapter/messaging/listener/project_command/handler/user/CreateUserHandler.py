...
"""
c4model|cb|project:ComponentQueue(project__messaging_project_command_handler__CreateUserHandler, "Create User", "project command consumer", "Create User")
c4model:Rel(project__messaging_project_command_handler__CreateUserHandler, project__domainmodel_event__UserCreated, "User Created", "message")
"""
