...
class CreateUserHandler(Handler):
    ...
    def handleCommand(self, messageData: dict) -> dict:
        ...
        obj: User = appService.createUser(id=dataDict['id'], name=dataDict['name'], firstName=dataDict['first_name'],
        ...
        return {'name': self._commandConstant.value, 'created_on': round(time.time() * 1000),
                'data': {'id': obj.id(), 'name': obj.name(), 'first_name': obj.firstName(), 'last_name': obj.lastName(),
