...
"""
c4model|cb|project:ComponentQueue(project__messaging_project_command_handler__UpdateUserHandler, "Update User", "project command consumer", "Update User")
c4model:Rel(project__messaging_project_command_handler__UpdateUserHandler, project__domainmodel_event__UserUpdated, "User Updated", "message")
"""
