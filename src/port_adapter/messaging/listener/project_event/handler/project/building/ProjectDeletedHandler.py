...
from src.port_adapter.messaging.listener.common.handler.project.building.DeleteBuildingsByProjectIdHandler import (
    DeleteBuildingsByProjectIdHandler as Handler,
)
