...
class Equipment(Base):
    ...
    equipmentProjectCategoryId = Column('equipment_project_category_id', String(40), ForeignKey('equipment_project_category.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=True)
    ...
    buildingId = Column('building_id', String(40), ForeignKey('building.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=True)
    ...
    buildingLevelRoomId = Column('building_level_room_id', String(40), ForeignKey('building_level_room.id', ondelete='CASCADE', onupdate='CASCADE'), nullable=True)
