...
class Project(Base):
    ...
    developerCityId = Column('developer_city_id', Integer,
                             ForeignKey('city.geoname_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=True)
    developerCountryId = Column('developer_country_id', Integer,
                                ForeignKey('country.geoname_id', ondelete='CASCADE', onupdate='CASCADE'), nullable=True)
