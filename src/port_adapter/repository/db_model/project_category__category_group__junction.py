...
associationTable = Table('equipment_project_category__category_group__junction', Base.metadata,
                         Column('equipment_project_category_id', Integer, ForeignKey('equipment_project_category.id')),
                         Column('equipment_category_group_id', Integer, ForeignKey('equipment_category_group.id'))
                         )
