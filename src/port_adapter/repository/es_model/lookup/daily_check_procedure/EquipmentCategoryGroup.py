...
class EquipmentCategoryGroup(InnerDoc):
    id = Keyword()
    name = Keyword()

    @classmethod
    def attributeDataBySnakeCaseAttributeName(cls, instance: 'EquipmentCategoryGroup' = None, snakeCaseAttributeName: str = None) -> EsModelAttributeData:
