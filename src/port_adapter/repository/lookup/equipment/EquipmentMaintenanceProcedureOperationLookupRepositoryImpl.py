...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationLookupRepository import EquipmentMaintenanceProcedureOperationLookupRepository
...
class EquipmentMaintenanceProcedureOperationLookupRepositoryImpl(EquipmentMaintenanceProcedureOperationLookupRepository):
    def __init__(self):
        try:
            ...
            logger.warn(
                f"[{EquipmentMaintenanceProcedureOperationLookupRepositoryImpl.__init__.__qualname__}] Could not connect to the db, message: {e}"
            )
