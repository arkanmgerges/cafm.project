...
from src.application.lookup.equipment.EquipmentMaintenanceProcedureOperationParameterLookupRepository import EquipmentMaintenanceProcedureOperationParameterLookupRepository
...
class EquipmentMaintenanceProcedureOperationParameterLookupRepositoryImpl(EquipmentMaintenanceProcedureOperationParameterLookupRepository):
    def __init__(self):
        try:
            ...
            logger.warn(
                f"[{EquipmentMaintenanceProcedureOperationParameterLookupRepositoryImpl.__init__.__qualname__}] Could not connect to the db, message: {e}"
            )
