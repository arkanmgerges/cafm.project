...
from src.application.lookup.equipment.EquipmentUnitLookupRepository import EquipmentUnitLookupRepository
...
class EquipmentUnitLookupRepositoryImpl(EquipmentUnitLookupRepository):
    def __init__(self):
        try:
            ...
            logger.warn(
                f"[{EquipmentUnitLookupRepositoryImpl.__init__.__qualname__}] Could not connect to the db, message: {e}"
            )
