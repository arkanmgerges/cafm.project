...
from src.application.lookup.equipment.MaintenanceProcedureOperationParameterLookupRepository import MaintenanceProcedureOperationParameterLookupRepository
...
class MaintenanceProcedureOperationParameterLookupRepositoryImpl(MaintenanceProcedureOperationParameterLookupRepository):
    def __init__(self):
        try:
            ...
            logger.warn(
                f"[{MaintenanceProcedureOperationParameterLookupRepositoryImpl.__init__.__qualname__}] Could not connect to the db, message: {e}"
            )
