...
class ProjectRepositoryImpl(ProjectRepository):
    ...
    def _updateDbObjectByObj(self, dbObject: DbProject, obj: Project):
        ...
        dbObject.developerCityId = (
            obj.developerCityId() if obj.developerCityId() is not None else dbObject.developerCityId
        )
        dbObject.developerCountryId = (
            obj.developerCountryId() if obj.developerCountryId() is not None else dbObject.developerCountryId
        )
        ...
        dbObject.developerContactPerson = (
            obj.developerContact() if obj.developerContact() is not None else dbObject.developerContactPerson
        )
        ...
        dbObject.developerPhone = (
            obj.developerPhoneNumber() if obj.developerPhoneNumber() is not None else dbObject.developerPhone
        )
        dbObject.developerWarranty = (
            obj.developerWarranty() if obj.developerWarranty() is not None else dbObject.developerWarranty
        )
        dbObject.developerPostalCode = (
            obj.developerPostalCode() if obj.developerPostalCode() is not None else dbObject.developerPostalCode
        )
        return dbObject
