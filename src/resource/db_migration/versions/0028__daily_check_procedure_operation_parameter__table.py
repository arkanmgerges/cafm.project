...
def upgrade(migrate_engine):
    ...
    Index('ix__daily_check_proc_op_param__daily_check_proc_op_id', tbl.c.daily_check_procedure_operation_id)
    Index('ix__daily_check_proc_op_param__unit_id', tbl.c.unit_id)
    tbl.create()
