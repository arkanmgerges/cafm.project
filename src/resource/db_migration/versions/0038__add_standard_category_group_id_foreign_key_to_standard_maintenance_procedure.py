...
def downgrade(migrate_engine):
    ...
    with migrate_engine.connect() as conn:
        conn.execute(
            "ALTER TABLE maintenance_procedure DROP CONSTRAINT fk__maintenance_procedure__st_eq_cat_gr__id"
        )
        conn.execute(
            "ALTER TABLE maintenance_procedure DROP COLUMN standard_equipment_category_group_id"
        )
