...
_BUILDING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.project.Building.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.project.project.Building.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="projectId",
            full_name="cafm.project.project.Building.projectId",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="buildingLevels",
            full_name="cafm.project.project.Building.buildingLevels",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
