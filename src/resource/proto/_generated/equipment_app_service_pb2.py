...
_EQUIPMENTAPPSERVICE_EQUIPMENTBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_EQUIPMENTAPPSERVICE_EQUIPMENTBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="equipment",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentByIdResponse.equipment",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_EQUIPMENTAPPSERVICE_EQUIPMENTSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentsRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentsRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentsRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_EQUIPMENTAPPSERVICE_EQUIPMENTSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="equipments",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentsResponse.equipments",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.project.equipment.EquipmentAppService_equipmentsResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_EQUIPMENTAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.equipment.EquipmentAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_EQUIPMENTAPPSERVICE_EQUIPMENTBYIDRESPONSE.fields_by_name[
    "equipment"
].message_type = equipment__pb2._EQUIPMENT
_EQUIPMENTAPPSERVICE_EQUIPMENTSREQUEST.fields_by_name[
    "order"
].message_type = order__pb2._ORDER
_EQUIPMENTAPPSERVICE_EQUIPMENTSRESPONSE.fields_by_name[
    "equipments"
].message_type = equipment__pb2._EQUIPMENT
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_equipmentByIdRequest"
] = _EQUIPMENTAPPSERVICE_EQUIPMENTBYIDREQUEST
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_equipmentByIdResponse"
] = _EQUIPMENTAPPSERVICE_EQUIPMENTBYIDRESPONSE
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_equipmentsRequest"
] = _EQUIPMENTAPPSERVICE_EQUIPMENTSREQUEST
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_equipmentsResponse"
] = _EQUIPMENTAPPSERVICE_EQUIPMENTSRESPONSE
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_newIdRequest"
] = _EQUIPMENTAPPSERVICE_NEWIDREQUEST
DESCRIPTOR.message_types_by_name[
    "EquipmentAppService_newIdResponse"
] = _EQUIPMENTAPPSERVICE_NEWIDRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

EquipmentAppService_equipmentByIdRequest = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_equipmentByIdRequest",
    (_message.Message,),
    {
...
EquipmentAppService_equipmentByIdResponse = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_equipmentByIdResponse",
    (_message.Message,),
    {
...
EquipmentAppService_equipmentsRequest = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_equipmentsRequest",
    (_message.Message,),
    {
...
EquipmentAppService_equipmentsResponse = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_equipmentsResponse",
    (_message.Message,),
    {
...
EquipmentAppService_newIdRequest = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_newIdRequest",
    (_message.Message,),
    {
...
EquipmentAppService_newIdResponse = _reflection.GeneratedProtocolMessageType(
    "EquipmentAppService_newIdResponse",
    (_message.Message,),
    {
...
_EQUIPMENTAPPSERVICE = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="newId",
            full_name="cafm.project.equipment.EquipmentAppService.newId",
            index=2,
            containing_service=None,
