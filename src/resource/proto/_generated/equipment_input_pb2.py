...
_EQUIPMENTINPUT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.equipment_input.EquipmentInput.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.project.equipment_input.EquipmentInput.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="cafm.project.equipment_input.EquipmentInput.value",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="unitId",
            full_name="cafm.project.equipment_input.EquipmentInput.unitId",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="equipmentId",
            full_name="cafm.project.equipment_input.EquipmentInput.equipmentId",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
EquipmentInput = _reflection.GeneratedProtocolMessageType(
    "EquipmentInput",
    (_message.Message,),
    {
