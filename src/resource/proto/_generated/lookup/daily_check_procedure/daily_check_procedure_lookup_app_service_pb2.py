...
_DAILYCHECKPROCEDURELOOKUPAPPSERVICE_LOOKUPREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='orderss', full_name='cafm.project.lookup.daily_check_procedure.DailyCheckProcedureLookupAppService_lookupRequest.orderss', index=2,
...
_DAILYCHECKPROCEDURELOOKUPAPPSERVICE_LOOKUPREQUEST.fields_by_name['orderss'].message_type = order__pb2._ORDER
