...
_DAILYCHECKPROCEDURELOOKUPAPPSERVICE_LOOKUPRESPONSE.fields_by_name['dailyCheckProcedureLookups'].message_type = lookup_dot_daily__check__procedure_dot_daily__check__procedure__pb2._DAILYCHECKPROCEDURE
