...
# source: lookup/daily_check_procedure/equipment_category_group.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lookup/daily_check_procedure/equipment_category_group.proto',
  package='cafm.project.lookup.daily_check_procedure',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n;lookup/daily_check_procedure/equipment_category_group.proto\x12)cafm.project.lookup.daily_check_procedure\"2\n\x16\x45quipmentCategoryGroup\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\tb\x06proto3'
)
...
EquipmentCategoryGroup = _reflection.GeneratedProtocolMessageType('EquipmentCategoryGroup', (_message.Message,), {
  ...
  '__module__' : 'lookup.daily_check_procedure.equipment_category_group_pb2'
