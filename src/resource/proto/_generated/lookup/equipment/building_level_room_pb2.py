...
# source: lookup/equipment/building_level_room.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lookup/equipment/building_level_room.proto',
  package='cafm.project.lookup.equipment',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n*lookup/equipment/building_level_room.proto\x12\x1d\x63\x61\x66m.project.lookup.equipment\"B\n\x11\x42uildingLevelRoom\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x03 \x01(\tb\x06proto3'
)
...
BuildingLevelRoom = _reflection.GeneratedProtocolMessageType('BuildingLevelRoom', (_message.Message,), {
  ...
  '__module__' : 'lookup.equipment.building_level_room_pb2'
