...
_MAINTENANCEPROCEDURE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.type",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="frequency",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.frequency",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start_date",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.start_date",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="sub_type",
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.sub_type",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="cafm.project.lookup.equipment.MaintenanceProcedure.maintenance_procedure_operations",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
