...
_MAINTENANCEPROCEDUREOPERATIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unitId', full_name='cafm.project.maintenance_procedure_operation_parameter.MaintenanceProcedureOperationParameter.unitId', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='maintenanceProcedureOperationId', full_name='cafm.project.maintenance_procedure_operation_parameter.MaintenanceProcedureOperationParameter.maintenanceProcedureOperationId', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='minValue', full_name='cafm.project.maintenance_procedure_operation_parameter.MaintenanceProcedureOperationParameter.minValue', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='maxValue', full_name='cafm.project.maintenance_procedure_operation_parameter.MaintenanceProcedureOperationParameter.maxValue', index=5,
