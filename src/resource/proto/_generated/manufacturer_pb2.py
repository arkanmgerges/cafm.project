...
DESCRIPTOR = _descriptor.FileDescriptor(
    name="manufacturer.proto",
    package="cafm.project.manufacturer",
    syntax="proto3",
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
    serialized_pb=b'\n\x12manufacturer.proto\x12\x19\x63\x61\x66m.project.manufacturer"(\n\x0cManufacturer\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\tb\x06proto3',
)
...
_MANUFACTURER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.manufacturer.Manufacturer.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="cafm.project.manufacturer.Manufacturer.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
Manufacturer = _reflection.GeneratedProtocolMessageType(
    "Manufacturer",
    (_message.Message,),
    {
        "DESCRIPTOR": _MANUFACTURER,
        "__module__": "manufacturer_pb2"
