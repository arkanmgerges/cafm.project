...
_DAILYCHECKPROCEDURELOOKUPAPPSERVICE_LOOKUPRESPONSE.fields_by_name['daily_check_procedures'].message_type = project_dot_lookup_dot_daily__check__procedure_dot_daily__check__procedure__pb2._DAILYCHECKPROCEDURE
