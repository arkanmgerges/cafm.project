...
# source: project/unit_app_service.proto
...
_UNITAPPSERVICE_UNITBYIDRESPONSE.fields_by_name['unit'].message_type = project_dot_unit__pb2._UNIT
_UNITAPPSERVICE_UNITSREQUEST.fields_by_name['orders'].message_type = order__pb2._ORDER
_UNITAPPSERVICE_UNITSRESPONSE.fields_by_name['units'].message_type = project_dot_unit__pb2._UNIT
...
UnitAppService_unitByIdRequest = _reflection.GeneratedProtocolMessageType('UnitAppService_unitByIdRequest', (_message.Message,), {
  ...
  '__module__' : 'project.unit_app_service_pb2'
