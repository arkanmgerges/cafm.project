...
_USERAPPSERVICE_USERSBYORGANIZATIONREQUEST = _descriptor.Descriptor(
  name='UserAppService_usersByOrganizationRequest',
  full_name='cafm.project.user.UserAppService_usersByOrganizationRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='organizationId', full_name='cafm.project.user.UserAppService_usersByOrganizationRequest.organizationId', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resultFrom', full_name='cafm.project.user.UserAppService_usersByOrganizationRequest.resultFrom', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='resultSize', full_name='cafm.project.user.UserAppService_usersByOrganizationRequest.resultSize', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='order', full_name='cafm.project.user.UserAppService_usersByOrganizationRequest.order', index=3,
...
_USERAPPSERVICE_USERSBYORGANIZATIONRESPONSE = _descriptor.Descriptor(
  name='UserAppService_usersByOrganizationResponse',
  full_name='cafm.project.user.UserAppService_usersByOrganizationResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='users', full_name='cafm.project.user.UserAppService_usersByOrganizationResponse.users', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='totalItemCount', full_name='cafm.project.user.UserAppService_usersByOrganizationResponse.totalItemCount', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERAPPSERVICE_USERSBYORGANIZATIONREQUEST.fields_by_name['order'].message_type = order__pb2._ORDER
_USERAPPSERVICE_USERSBYORGANIZATIONRESPONSE.fields_by_name['users'].message_type = user__pb2._USER
...
DESCRIPTOR.message_types_by_name['UserAppService_usersByOrganizationRequest'] = _USERAPPSERVICE_USERSBYORGANIZATIONREQUEST
DESCRIPTOR.message_types_by_name['UserAppService_usersByOrganizationResponse'] = _USERAPPSERVICE_USERSBYORGANIZATIONRESPONSE
...
UserAppService_usersByOrganizationRequest = _reflection.GeneratedProtocolMessageType('UserAppService_usersByOrganizationRequest', (_message.Message,), {
  'DESCRIPTOR' : _USERAPPSERVICE_USERSBYORGANIZATIONREQUEST,
  '__module__' : 'user_app_service_pb2'
  # @@protoc_insertion_point(class_scope:cafm.project.user.UserAppService_usersByOrganizationRequest)
  })
_sym_db.RegisterMessage(UserAppService_usersByOrganizationRequest)

UserAppService_usersByOrganizationResponse = _reflection.GeneratedProtocolMessageType('UserAppService_usersByOrganizationResponse', (_message.Message,), {
  'DESCRIPTOR' : _USERAPPSERVICE_USERSBYORGANIZATIONRESPONSE,
  '__module__' : 'user_app_service_pb2'
  # @@protoc_insertion_point(class_scope:cafm.project.user.UserAppService_usersByOrganizationResponse)
  })
_sym_db.RegisterMessage(UserAppService_usersByOrganizationResponse)
...
_USERAPPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='usersByOrganization',
    full_name='cafm.project.user.UserAppService.usersByOrganization',
    index=3,
    containing_service=None,
    input_type=_USERAPPSERVICE_USERSBYORGANIZATIONREQUEST,
    output_type=_USERAPPSERVICE_USERSBYORGANIZATIONRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
