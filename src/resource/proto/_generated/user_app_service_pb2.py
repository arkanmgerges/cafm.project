...
_USERAPPSERVICE_USERBYEMAILREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="email",
            full_name="cafm.project.user.UserAppService_userByEmailRequest.email",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYEMAILRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user",
            full_name="cafm.project.user.UserAppService_userByEmailResponse.user",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERBYIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.user.UserAppService_userByIdRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user",
            full_name="cafm.project.user.UserAppService_userByIdResponse.user",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="resultFrom",
            full_name="cafm.project.user.UserAppService_usersRequest.resultFrom",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="resultSize",
            full_name="cafm.project.user.UserAppService_usersRequest.resultSize",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="order",
            full_name="cafm.project.user.UserAppService_usersRequest.order",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_USERAPPSERVICE_USERSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="users",
            full_name="cafm.project.user.UserAppService_usersResponse.users",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="itemCount",
            full_name="cafm.project.user.UserAppService_usersResponse.itemCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_USERAPPSERVICE_NEWIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="cafm.project.user.UserAppService_newIdResponse.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_USERAPPSERVICE_USERBYEMAILRESPONSE.fields_by_name[
    "user"
].message_type = user__pb2._USER
...
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByEmailRequest"
] = _USERAPPSERVICE_USERBYEMAILREQUEST
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByEmailResponse"
] = _USERAPPSERVICE_USERBYEMAILRESPONSE
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByIdRequest"
] = _USERAPPSERVICE_USERBYIDREQUEST
DESCRIPTOR.message_types_by_name[
    "UserAppService_userByIdResponse"
] = _USERAPPSERVICE_USERBYIDRESPONSE
DESCRIPTOR.message_types_by_name[
    "UserAppService_usersRequest"
] = _USERAPPSERVICE_USERSREQUEST
DESCRIPTOR.message_types_by_name[
    "UserAppService_usersResponse"
] = _USERAPPSERVICE_USERSRESPONSE
DESCRIPTOR.message_types_by_name[
    "UserAppService_newIdRequest"
] = _USERAPPSERVICE_NEWIDREQUEST
DESCRIPTOR.message_types_by_name[
    "UserAppService_newIdResponse"
] = _USERAPPSERVICE_NEWIDRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

UserAppService_userByEmailRequest = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByEmailRequest",
    (_message.Message,),
    {
...
UserAppService_userByEmailResponse = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByEmailResponse",
    (_message.Message,),
    {
...
UserAppService_userByIdRequest = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByIdRequest",
    (_message.Message,),
    {
...
UserAppService_userByIdResponse = _reflection.GeneratedProtocolMessageType(
    "UserAppService_userByIdResponse",
    (_message.Message,),
    {
...
UserAppService_usersRequest = _reflection.GeneratedProtocolMessageType(
    "UserAppService_usersRequest",
    (_message.Message,),
    {
...
UserAppService_usersResponse = _reflection.GeneratedProtocolMessageType(
    "UserAppService_usersResponse",
    (_message.Message,),
    {
...
UserAppService_newIdRequest = _reflection.GeneratedProtocolMessageType(
    "UserAppService_newIdRequest",
    (_message.Message,),
    {
...
UserAppService_newIdResponse = _reflection.GeneratedProtocolMessageType(
    "UserAppService_newIdResponse",
    (_message.Message,),
    {
