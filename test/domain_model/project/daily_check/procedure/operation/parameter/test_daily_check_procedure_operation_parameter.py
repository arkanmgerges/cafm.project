...
def test_toMap():
    ...
    currentMap = {
        "daily_check_procedure_operation_parameter_id": "1",
        "name": "name",
        "unit_id": "unit_id",
...
def _create_object(
    ...
    dailyCheckProcedureOperationId = (
        "daily_check_procedure_operation_id"
        if dailyCheckProcedureOperationId is None
        else dailyCheckProcedureOperationId
    )
