...
def _create_object(id: str = None, name: str = None, description: str = None, type: str = None, dailyCheckProcedureId: str = None, skipValidation: bool = False):
    ...
    dailyCheckProcedureId = 'daily_check_procedure_id' if dailyCheckProcedureId is None else dailyCheckProcedureId

    return DailyCheckProcedureOperation.createFrom(id=id, name=name, description=description, type=type, dailyCheckProcedureId=dailyCheckProcedureId, skipValidation=skipValidation)
