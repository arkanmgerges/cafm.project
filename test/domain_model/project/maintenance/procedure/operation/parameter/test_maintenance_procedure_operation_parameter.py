...
def test_toMap():
    ...
    currentMap = {
        "maintenance_procedure_operation_parameter_id": "1",
        "name": "name",
        "unit_id": "unit_id",
...
def _create_object(
    ...
    maintenanceProcedureOperationId = (
        "maintenance_procedure_operation_id"
        if maintenanceProcedureOperationId is None
        else maintenanceProcedureOperationId
    )
