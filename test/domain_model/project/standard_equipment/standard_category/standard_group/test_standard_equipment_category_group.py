...
def test_toMap():
    ...
    currentMap = {'standard_equipment_category_group_id': '1',
        'name': 'name',
...
def _create_object(id: str = None, name: str = None, standardEquipmentCategoryId: str = None, skipValidation: bool = False):
