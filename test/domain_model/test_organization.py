...
def test_that_two_objects_with_same_attributes_are_equal():
    # Act
    object1 = Organization.createFrom(
        id="1234", name="org1", organizationType="provider"
    )
    object2 = Organization.createFrom(
        id="1234", name="org1", organizationType="provider"
    )
    # Assert
...
def test_organization_update():
    ...
    object1.update(
        {
            "manager_first_name": "new mn fn",
            "manager_last_name": "new mn ln",
