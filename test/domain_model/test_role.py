...
def test_create_role_with_semantic_constructor():
    ...
    id = str(uuid4())
    # Act
    role = Role.createFrom(id=id, name='r1')
    # Assert
    assert isinstance(role, Role)
    assert role.id() == id
    assert role.name() == 'r1'
...
def test_that_two_objects_with_same_attributes_are_equal():
    # Act
    object1 = Role.createFrom('1234', 'r1')
    object2 = Role.createFrom('1234', 'r1')
    # Assert
...
def test_that_two_objects_with_different_attributes_are_not_equal():
    # Act
    object1 = Role.createFrom('1234', 'r1')
    object2 = Role.createFrom('1234', 'r2')
    # Assert
    assert object1 != object2
...
def test_that_address_be_set():
    # Act
    object1 = Role.createFrom(id='1234', name='r1')
    # Assert
